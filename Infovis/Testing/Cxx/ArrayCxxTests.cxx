...
int ArrayAPIDenseCoordinates(int, char*[]);
int ArrayDiagonalMatrixSource(int, char*[]);
int ArrayDotProductSimilarity(int, char*[]);
int ArrayExtractFactoredArray(int, char*[]);
int ArrayMatricizeArray(int, char*[]);
int TestArrayNorm(int, char*[]);
int ArrayNormalizeMatrixVectors(int, char*[]);
int ArraySparseArrayToTable(int, char*[]);
int ArrayTableToSparseArray(int, char*[]);
int ArrayToTable(int, char*[]);
int ArrayTransposeMatrix(int, char*[]);
int TestTableToArray(int, char*[]);
...
static functionMapEntry cmakeGeneratedFunctionMapEntries[] = {
  ...
  {
    "ArraySparseArrayToTable",
    ArraySparseArrayToTable
  },
  {
    "ArrayTableToSparseArray",
    ArrayTableToSparseArray
  },
  {
    "ArrayToTable",
